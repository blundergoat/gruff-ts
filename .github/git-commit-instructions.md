...
- **Do not bump schema version strings (`gruff.analysis.v2`, `gruff.baseline.v1`, `gruff.hotspot.v1`) in a commit unless the message explicitly calls out the breaking change** - these are public output contracts and downstream baseline files match them exactly.
