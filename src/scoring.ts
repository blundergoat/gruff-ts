...
// the full file list sorted worst-first; renderers cap it themselves (HTML and hotspot keep their
// 10-row UX, summary honours `--top`) so `summary --top 25` no longer silently returns 10 rows.
