// Behavioural coverage for the bounded intra-function AST flow pass (M25).
// Same-line coverage lives in security-and-config.test.ts; this file exercises
// the cross-line source-to-sink detection added on top of ts.createSourceFile.
