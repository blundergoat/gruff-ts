...
**Cross-reference:** the originating incident is in `.goat-flow/learning-loop/lessons/workflow.md` under "user-facing CLI commands must catch known error classes and print graceful messages" (2026-05-27). The lesson captures what went wrong; this pattern is the reusable shape to apply going forward.
