...
Prior discovery was implemented with a hardcoded default directory list plus gruff config `paths.ignore`. It did not apply repository ignore rules while walking directories.
